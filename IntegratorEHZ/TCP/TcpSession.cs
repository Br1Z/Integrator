...
namespace IntegratorEHZ
{
    ...
    public class TcpSession : IDisposable
    {
        ...
        /// <summary>
        /// Id Устройства текущего сеанса
        /// </summary>
        public int DeviceIdCurrentSession { get; set; }
        ...
        public virtual bool Disconnect()
        {
            ...
            Server.UnregisterIdDevice(DeviceIdCurrentSession);
        ...
        /// </summary>
        public virtual void HandlerForSendingASingleRequest(byte[] requestSend) { }
